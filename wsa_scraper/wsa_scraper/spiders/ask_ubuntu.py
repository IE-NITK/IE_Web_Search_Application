...
class askubuntu(scrapy.Spider):
    page_no =1
    name = 'askubuntu'
    start_urls = [
        "https://askubuntu.com/questions?tab=frequent&page={}".format(page_no)
    ]
    def parse(self, response):
        ...
        if self.page_no < 100:
            self.page_no +=1
            yield scrapy.Request(url = "https://askubuntu.com/questions?tab=frequent&page={}".format(self.page_no), callback=self.parse)
